...
| `CLAUDE.md` | 1326 | À trancher par l'auteur ; |
| `CLAUDE.md` | 1529 | À trancher par l'auteur : une passe générale sur les 99, ou la règle |
| `CLAUDE.md` | 1623 | À trancher par l'auteur : ce document ne dit rien du het final, et c'est |
...
| `CLAUDE.md` | 1223 | Décision de l'auteur du 8 septembre 2026. Le ה final se translittère `h` : |
| `CLAUDE.md` | 1412 | Décision de l'auteur du 12 septembre 2026, prise sur la mesure. Le corpus |
| `CLAUDE.md` | 1445 | Décision de l'auteur du 12 septembre 2026. Le corpus écrivait ==la même |
| `CLAUDE.md` | 1628 | Décision de l'auteur du 29 août 2026. Les noms propres reçoivent leur propre |
| `CLAUDE.md` | 1850 | Décision de l'auteur du 8 septembre 2026. Une chuqqah qui en cite une autre |
| `CLAUDE.md` | 2005 | Décision de l'auteur du 8 septembre 2026. La translittération donne ==les |
| `CLAUDE.md` | 2123 | …r verbe intraduisible de l'ONT, décision de l'auteur du 25 août 2026. L'acte de rater sa cible, … |
| `CLAUDE.md` | 2144 | … et l'espèce sont le même mot — décision de l'auteur du 12 septembre 2026, et le §2.5 porte la r… |
| `CLAUDE.md` | 2273 | Le sens du transport — décision de l'auteur du 30 août 2026. *La restitution |
| `CLAUDE.md` | 2565 | Décision de l'auteur du 8 septembre 2026. L'hébreu pose parfois le verbe |
| `CLAUDE.md` | 2631 | Décision de l'auteur du 10 septembre 2026. L'hébreu écrit cinq fois dans |
