...
Pour le nom d'un homme, on peut au moins dire ceci : le porter, c'est porter ==le fait d'être nommé==. Dans une généalogie qui n'existe que par les noms transmis, le fils aîné de celui qui recommence le monde s'appelle *Nom*.

## Celui qui couvre sans regarder
...
Ce qui reste à écrire : sa descendance se déploie en *Bereshit* 10 et 11, déjà écrits ; cette fiche s'enrichira quand la couche des Shemot y sera portée.
