...
C'est pourquoi les deux traductions courantes trahissent, chacune à sa façon. « Les nations » fait une abstraction — un collectif vague, l'humanité en dehors d'Israël, une masse sans contour. Et « les gentils » est pire : le mot vient d'une catégorie ==religieuse tardive==, forgée pour dire les non-juifs, puis les non-chrétiens. Il projette sur la table des nations une frontière de croyance là où le texte trace des frontières de langue et de sol — et il rend illisible ce qui suit.

Car ce qui suit est une promesse. Quand **YHWH** dit à ==Avram== qu'il sera le père d'une ==multitude de goyim==, il ne dit pas qu'il aura beaucoup de disciples. Il dit que des ==peuples entiers== — avec leurs langues, leurs terres, leurs rois — se rattacheront à lui. La table des soixante-dix n'est pas un catalogue d'étrangers : c'est ==la liste de ceux que la promesse vise==.
