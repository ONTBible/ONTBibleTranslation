...
Notre justice est une ==abstraction== — une idée qu'on peut discuter en soi, une balance suspendue hors du monde, une norme dont les cas particuliers seraient des applications. Le ==mishpat== ne s'abstrait pas. Il est ==toujours rendu==, toujours dans une affaire, toujours par quelqu'un qui a regardé. C'est la décision qui ==discerne et remet les parties dans l'ordre== : celui qui a pris rend, celui qui a perdu retrouve, et ce qui était de travers se tient droit.

Le mot va donc rarement seul. Il forme un couple avec **tsedaqah**, et le corpus les tient presque toujours ensemble : la **tsedaqah** est l'ordre juste, le ==mishpat== est le jugement qui le rétablit. L'un est l'état, l'autre l'acte. Séparés, chacun devient une abstraction — exactement ce qui est arrivé en français, où « justice » a fini par recouvrir les deux et n'en dire plus aucun.
