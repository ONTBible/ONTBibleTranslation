...
*ba-NA* — deux syllabes, accent sur la dernière, ==qui est la règle générale== (§2.12).

Le *h* final est un ==he==, et il ==ne se prononce pas== : c'est une lettre-support, qui porte la voyelle sans ajouter de son. On dit *ba-NA*. ==Ne pas l'aspirer== — et ne pas le confondre avec le he initial de *hineni*, qui s'entend, lui.
...
Laquelle ? Le texte l'a dit juste avant : *ezer kenegdo* — un appui qui fait face. On bâtit ==pour==. Une maison est bâtie pour qu'on y habite, un mur pour qu'il porte ; la **ʾIshah** est ==banah== pour tenir en vis-à-vis de l'**ʾIsh**, ce qu'il ne pouvait pas faire seul et qui manquait au monde — le seul ==lo tov== de toute la page.
