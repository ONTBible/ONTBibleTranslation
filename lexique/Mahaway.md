...
`Ma-ha-WAY` — trois syllabes, accent sur la dernière, ==qui est la règle générale== (§2.12).
...
Il est fils de [[Baraqel]], et le corpus le désigne comme ==le **mal'akh** des **gibbaraya**== — leur envoyé.

## Ce que le corpus en fait

Et c'est ce titre qui est ==le cœur de la chose==.

Un **mal'akh** est défini par l'envoi, non par la nature : celui que **YHWH** mandate pour porter un acte dans le monde. Ici, ==l'envoi vient d'en bas==, et le corpus le dit : ==un envoi sans mandat divin — inversion de la structure du **mal'akh** **YHWH**==.
...
Ceux qui ont rompu les domaines envoient donc un des leurs ==demander un verdict==. C'est la scène la plus étrange du livre, et la plus sobre.
