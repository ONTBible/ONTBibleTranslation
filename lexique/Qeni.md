...
*Qe-NI* — deux syllabes, accent sur la dernière, ==qui est la règle générale== (§2.12).

Le *q* est un ==qof== : un *k* produit ==tout au fond, contre la luette==.

## Le Shem

Une enclume qui se déplace.

(*Qeni* / הַקֵּינִי) se rattache à *qin* (*qin* / קַיִן) — ==la lance, et celui qui la forge==. Le mot désigne l'objet de métal pointu et, par la main qui le fait, le métier : le forgeron.
...
Ils ouvrent la liste des dix peuples que **YHWH** énumère à [[ʾAvram]] après la **berith** coupée entre les morceaux — la seule fois où le corpus les nomme jusqu'ici.
...
Le corpus ne commente pas, et c'est sa manière. Il énumère, et laisse la liste faire son effet.

## Ce que la fiche porte, et ce qu'elle attend

Elle repose sur *Genèse* 15:19, une seule mention, et sur ce que la racine permet de dire sans inventer.
