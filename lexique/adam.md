...
Le verbe employé n'est pas non plus celui du premier chapitre. Là, **Elohim** formulait et cela était. Ici, il ==façonne== — *yatsar*, le verbe du potier. Il prend en main, il pétrit, il approche son visage et souffle dans des narines. C'est le même **Elohim**, dans une tout autre proximité.

Une chose déroute et il faut la tenir : ==adam== n'est pas un nom propre dans ces chapitres, et ce n'est pas non plus « un homme » par opposition à une femme. C'est ==l'être tiré du sol==, la catégorie. Il n'y a pas d'**Ish** tant que personne ne se tient en face — le mot n'apparaît qu'à ce moment-là, et il apparaît en même temps que **Ishah**.

Ce que la charge implique se lit dans le mandat : servir le Jardin et le garder, *avad* et *shamar*. Ces deux verbes-là ne sont pas des mots d'agriculture. Ce sont ceux du service du sanctuaire — les mêmes qui décriront le travail des **kohanim** dans le Tabernacle. L'==adam== n'est pas un exploitant, il est un desservant.
