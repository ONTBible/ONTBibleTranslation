...
L'hébreu la lit autrement. Il y entend *balal* (*balal* / בָּלַל) — ==confondre, mêler jusqu'à ce que rien ne se distingue==. Ce n'est pas une étymologie savante : c'est ==une polémique==, et elle est délibérée. Là où la ville dit *porte des dieux*, le corpus dit ==brouillard==.

## Deux apparitions, et l'écart entre elles
...
==La charge s'accumule à travers le corpus==, elle n'est pas donnée d'emblée. C'est une des manières du texte : il nomme d'abord neutre, puis il revient.
