...
(*Kaftorim* / כַּפְתֹּרִים) — ==Kaftor==, la Crète, ou plus largement les peuples de la mer Égée.
...
Leur position dans la liste est double et un peu troublante : ils y figurent ==comme frères des [[Kasluchim]]==, et *Amos* 9:7 fait monter les [[Pelishtim]] ==de Kaftor==.
...
C'est un bon rappel : cette table ==range ce qu'on savait==, avec le flou de ce qu'on savait.
