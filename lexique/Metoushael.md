...
Second nom de la lignée à porter ==**ʾEl**==, juste après [[Mechouyael]]. Le nom s'écrit (*Metoushaël* / מְתוּשָׁאֵל) et se décompose en *methu* — l'homme, au sens ancien qu'on ne retrouve plus que dans les noms composés — et *shaël*, ==demandé==.
...
## La seconde génération qui porte **ʾEl**

Cinquième dans la ligne de [[Qayin]]. Il engendre [[Lamekh-fils-de-Metoushael]], et la lignée s'achève sur lui.

Avec [[Mechouyael]] son père, il forme ==le seul endroit de cette généalogie où le divin entre dans les noms==. Deux fois de suite, puis plus jamais : le fils qu'il engendre s'appelle d'un nom que personne ne sait ouvrir, et c'est lui qui chantera le sang.

Le corpus ne commente pas cette extinction. Il la laisse se voir dans la suite des noms.
