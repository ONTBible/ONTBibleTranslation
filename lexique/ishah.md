...
C'est ce que le texte appelle *ezer kenegdo*, et il faut y regarder de près parce que les traductions l'ont abîmé des deux côtés. *Ezer* n'est pas une assistance subalterne : ailleurs dans le corpus, c'est **YHWH** lui-même qui est l'*ezer* d'Israël — un appui sans lequel on ne tient pas. Et *kenegdo* dit « en face de lui », littéralement : ni au-dessus, ni au-dessous, ni derrière. ==En vis-à-vis.== Deux qui se répondent.

D'où l'intraduisible. « Femme » et « homme » sont chez nous des catégories sociales — des rôles, des statuts, des places dans une organisation. ==Ishah== et **Ish** ne sont pas des rôles : ce sont ==deux termes qui se définissent l'un par l'autre==, comme les deux moitiés d'une même parole. Le jeu de sons hébreu le fait entendre et le français ne peut pas le rendre : *ish* et *ishah*, une seule syllabe d'écart. Traduire, c'est couper le lien qui les tient.
