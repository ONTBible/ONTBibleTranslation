...
Et c'est un fait à relever plutôt qu'à combler : ==le texte ne commente pas ce **Shem**==, alors qu'il commente presque tous les autres de ce chapitre. Il laisse ==le récit établir l'homme==.

Ce qu'il dit, en revanche, est sa provenance : il sort de [[Koush]], fils de [[Cham]]. Or la lignée de [[Cham]] porte ==la chaleur vitale, la fécondité, la force qui bâtit==. ==Nimrod== en est cette puissance ==portée à son expression politique et militaire maximale==.

## Celui qui commence

Le verbe employé pour lui est ==celui d'un commencement==, et il revient deux fois.
...
C'est la manière du texte : il pose, et il attend. La charge s'accumulera ailleurs.
