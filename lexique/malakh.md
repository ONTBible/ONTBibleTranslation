...
==Malʾakh== vient d'une racine qui veut dire envoyer, déléguer. Il ne désigne ==aucune espèce d'être==. Il désigne une ==fonction== : celui que **YHWH** mandate pour accomplir un acte dans le monde des hommes. Un ==malʾakh== (*malʾakh* / מַלְאַךְ) n'est pas défini par ce qu'il est, mais par ce pour quoi il a été envoyé — et cela suffit à le nommer, parce que dans cette langue une chose est ce qu'elle fait.

Voilà pourquoi « ange » est un contresens si complet qu'il empêche de lire. Notre ange est une créature : il a une nature — spirituelle, immatérielle —, un rang dans une hiérarchie, des ailes dans les tableaux. Toute cette architecture est grecque, puis médiévale, et elle recouvre exactement ce que l'hébreu ne dit pas. Un ==malʾakh== peut être un homme, un envoyé quelconque : le même mot sert pour le messager qu'un roi expédie à un autre roi.

Et l'ambiguïté est ==délibérée==. Le ==malʾakh== de **YHWH** parle tantôt en son nom propre, tantôt comme **YHWH** lui-même, et le texte ne tranche jamais. Ce n'est pas une négligence de rédaction : un envoyé porte l'autorité de qui l'envoie, au point qu'on ne sait plus qui parle — et c'est précisément le point.
