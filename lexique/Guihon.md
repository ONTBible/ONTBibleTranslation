...
De *giach* (*giach* / גִּיחַ) — ==jaillir, sourdre avec force==.

Comme [[Pishon]], ==le nom dit le mouvement de l'eau== plutôt qu'un lieu.
...
Le **Shem** reviendra pour ==la source de Yeroushalayim==, celle où Shelomo sera oint roi. Le corpus ne relie pas les deux.
