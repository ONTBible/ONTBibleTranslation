...
Et il ne faut pas se hâter d'y voir une âme. La ==Neshamah== n'est pas une pièce immatérielle logée dans un corps, qui en sortirait à la mort pour aller ailleurs : cette architecture est grecque et le corpus l'ignore. La ==Neshamah== est ==le souffle même==, celui qui entre et sort de toi maintenant, et qui vient de là. On ne l'a pas ; on la respire.
