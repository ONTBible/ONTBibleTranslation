...
Ce qui déplace ce qu'on croit lire dans les fêtes du corpus. Nous appelons cela des « fêtes » ou des « saisons », et le mot suggère une commémoration : on se souvient ensemble d'un événement passé. Le ==moed== ne commémore pas d'abord. C'est ==un rendez-vous fixé== — un moment où l'on se présente, parce qu'on est attendu.
