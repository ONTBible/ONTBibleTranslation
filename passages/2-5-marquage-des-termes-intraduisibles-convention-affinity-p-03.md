...
*Passage engendré — ne pas éditer. Source : `CLAUDE.md`, section « 2.5 Marquage des termes intraduisibles — convention Affinity Publisher », partie 3. Empreinte de la section : `ab83c0a805f0b778`. Régénérer : `python3 knowledge/decouper.py`.*
