# ONT — Ordre canonique et numérotation globale du corpus

Référence pour l'arborescence, la navigation et la table des matières.  
L'IDE trie alphabétiquement — les préfixes numériques forcent l'ordre fonctionnel.  
**Ne jamais utiliser l'ordre alphabétique comme ordre de référence.**

---

## Conventions de préfixage
...
## Tableau global 01 – 70

### Kenesset — Torah (01-06)

| # | Livre | Hébreu |
|---|---|---|
| 01 | *Bereshit* (Genèse) | בְּרֵאשִׁית |
| 02 | *Shemot* (Exode) | שְׁמוֹת |
| 03 | *Vayiqra* (Lévitique) | וַיִּקְרָא |
| 04 | *Bemidbar* (Nombres) | בְּמִדְבַּר |
...
| # | Livre | Note |
|---|---|---|
| 11 | *Yirmeyahu* (Jérémie) | |
| 12 | *Ekha* (Lamentations) | Attaché à Yirmeyahu — lien historique direct |
| 13 | *Yehezqel* (Ézéchiel) | |
| 14 | *Yeshayahu* (Ésaïe) | En dernier : clôture sur la consolation |
...
| # | Livre | Fête |
|---|---|---|
| 30 | *Shir Hashirim* (Cantique) | Pessa'h |
| 31 | *Ruth* | Shavouot |
...
|---|---|---|
| 34 | *Ezra-Nehemyah* | |
| 35 | *Divrei Hayamim* (Chroniques) | En dernier : son dernier verset ouvre sur le retour |

**Corpus étendu :**

| # | Livre | Note |
|---|---|---|
| 36 | *Toledot Adam ve-Chavah* (Vie d'Adam et Ève) | Cas limite — à réévaluer |
| 37 | *Sefar Gibbaraya* (Livre des Géants) | |

### Kenesset — Nistarot (38-43)

**Principe :** chronologie narrative du visionnaire (quand le personnage est censé avoir vécu), clôture sur la restauration eschatologique.
...
## Berit Hadashah — Besorot (44-47)

Conteneur : `44. eduyot` (numéro de son premier livre).

| # | Livre | Groupe | Note |
|---|---|---|---|
| 44 | *Marqus* | Eduyot | Première *besorah* rédigée |
| 45 | *Matityahu* | Eduyot | |
| 46 | *Luqas* | Eduyot | |
| 47 | *Bereshit ha-Yohanan* | Séparée | *Besorah* cosmique-inaugurale — écho de *Bereshit* 1 |

## Berit Hadashah — Ketouvim (48)
...
| # | Livre | Date approx. | Note |
|---|---|---|---|
| 62 | *El Timotiyos alef* (1 Timothée) | ~90-110 EC | Pastorale — deutéro-paulinienne, reconstruction institutionnelle |
| 63 | *El Timotiyos bet* (2 Timothée) | ~90-110 EC | |
| 64 | *El Titos* (Tite) | ~90-110 EC | |
| 65 | *Igeret Yohanan alef* (1 Yohanan) | ~85-100 EC | |
| 66 | *Igeret Yohanan bet* (2 Yohanan) | ~90-100 EC | |
| 67 | *Igeret Yohanan gimel* (3 Yohanan) | ~90-100 EC | |
| 68 | *Igeret Kefa bet* (2 Kefa) | ~80-125 EC | Paire avec Yehudah — matériau commun |
| 69 | *Igeret Yehudah* (Lettre de Yehudah) | ~65-100 EC | **Mot final des Igerot** |

## Berit Hadashah — Nistarot (70)
