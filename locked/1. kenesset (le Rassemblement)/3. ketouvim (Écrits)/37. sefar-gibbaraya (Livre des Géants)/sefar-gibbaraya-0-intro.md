...
- *transmission* : la tradition hénochienne des **'irin** était *courante* dans le judaïsme du Second Temple (cycle de 1 *==Chanokh==*, milieu de Qumrân) ;
...
*Restitution* (voir standard §A). Ce livre n'a *aucun auteur nommé*. Il appartient au courant *hénochien* : il présuppose le récit des **'irin** de 1 *==Chanokh==* 6-16 et le déploie. Comme pour toute la littérature de ==Chanokh==, le nom marque la *provenance et l'autorité* d'une vérité — le savoir du scribe céleste qui « marche avec **Elohim** » (*Bereshit* 5:24) —, non un scribe physique. Ce n'est pas une fraude : c'est déclarer que cette vérité appartient au courant de ==Chanokh==, témoin des choses cachées.
...
- *admis au corps* : la descente des **'irin**, la transmission des *razin* hors mandat, l'union à travers les domaines, la naissance des **gibbaraya**, la Terre alourdie, les deux songes (le jardin, la tablette lavée), la mission de ==Mahaway== vers ==Chanokh==, la lettre du scribe (4Q203 fr. 8), le décret, le **mabbul** comme dé-création temporaire ;
- *tenu aux notes* (trace possible, distribution incertaine) : la répartition exacte des songes entre les rêveurs, la topographie du voyage de ==Mahaway==, la forme continue de la lettre de ==Chanokh== ;
...
| ==Mahaway==, **mal'akh** inversé | envoyé *d'en bas* vers ==Chanokh== — l'inverse du **mal'akh** **YHWH** mandaté d'en haut | 4Q530-531 ; versions manichéennes |
...
*Les songes et le scribe :* ④ le songe du jardin (feu, eaux, racine gardée) → ⑤ le songe de la tablette lavée → ⑥ ==Mahaway== envoyé vers ==Chanokh== → ⑦ la lettre du scribe à ==Shemikhazah==.
...
- Noms des **'irin** : ==Shemikhazah== (« mon **shem** a vu »), ==Azazel==, ==Baraqel== (« éclair d'El »). Noms des **gibbaraya** : ==Ohyah==, ==Hahyah==/==Ahyah== (vocalisation laissée ouverte), ==Mahaway==, ==Gilgamesh== et ==Hobabish== (reclassés sous jugement). ==Chanokh== le scribe ; ==Rafa'el== (« El guérit »), **mal'akh** du décret et de la restauration ; ==Noach==, la racine gardée. Tous sans gras, niveau 3 + glose à la première occurrence.
...
- *==Chanokh== lecteur du décret.* ==Mahaway== envoyé vers ==Chanokh== montre que le sens n'appartient pas aux puissants. ==Chanokh== ne devine ni ne fait de prodige : il reçoit, distingue, écrit, transmet. Sa lettre replace la violence des fils sous la faute des pères.
...
- Descente des **'irin**, secrets, corruption (ch. 1) : attesté par fragments, fortement soutenu par 1 *==Chanokh==*.
...
- ==Mahaway== **mal'akh** des **gibbaraya** vers ==Chanokh== (ch. 6) : attesté comme motif central.
- Lettre de ==Chanokh== (ch. 7) : attestée en 4Q203 fr. 8, reconstruite ici de façon continue.
- Décret détaillé contre ==Azazel==, ==Shemikhazah== et les **gibbaraya** (ch. 9) : surtout 1 *==Chanokh==* 10.
...
- Józef Milik, *The Books of Enoch* ; George Nickelsburg, travaux sur 1 *==Chanokh==* ; Annette Yoshiko Reed, travaux sur les **'irin** ; Matthew Goff, travaux sur ==Gilgamesh== dans le Livre des Géants.
