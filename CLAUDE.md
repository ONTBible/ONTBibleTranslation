...
**Architecture du corpus — quatre catégories ontologiques :**

Le corpus de l'ONT est structuré en quatre catégories fonctionnelles. Ce ne sont pas des divisions canoniques — ce sont des modes distincts d'engagement avec le réel. Le critère est ontologique : si la distinction fonctionnelle est réelle, elle mérite un nom (*qara*).
...
*Nistarot* (mode de traversée architecturale) : *Daniel*, *1 Khanokh*, *Yovelim* (Jubilés), *Sefar Gibbaraya*, corpus de Qumrân à substrat sémitique, *Chazon Avraham* (Apocalypse d'Abraham), *Chazon Ezra* (4 Ezra ch. 3-14 uniquement — ch. 1-2 et 15-16 sont des additions chrétiennes hellénisées exclues), *Chazon Barukh* (2 Baruch syriaque — original hébreu probable), *Tsava'at Lévi* (Testament de Lévi araméen de Qumrân — pas les Testaments des 12 Patriarches dans leur ensemble, trop christianisés).
