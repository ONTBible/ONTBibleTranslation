...
- **Bereshit 1** (Genèse 1:1 — 2:3) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-1.md` — référence fondatrice : toutes les conventions typographiques, le glossaire en action, les formules fixes. Toute traduction doit être cohérente avec elle.
- **Bereshit 2** (Genèse 2:4-25) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-2.md` — introduction de YHWH Elohim, *yatsar*, l'Eden comme Temple, *isha* / *ish*, *ezer kenegdo*, la *neshamah*.
- **Bereshit 3** (Genèse 3) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-3.md` — la rupture fonctionnelle, le *nachash*, les réorganisations cosmiques, *itsavon*, *arur*.
- **Bereshit 4** (Genèse 4) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-4.md` — Qayin et Hevel, *minchah*, *chattah*, *arur*, la ligne de Qayin.
- **Bereshit 5** (Genèse 5) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-5.md` — généalogie d'Adam à Noach, *toledot*, *hithalekh*, Khanokh.
- **Bereshit 6** (Genèse 6) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-6.md` — les Nephilim, la *berith* inaugurale, l'arche (*tevah*).
- **Bereshit 7** (Genèse 7-8) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-7.md` — le déluge, décréation et re-création, *tahor/lo tahor*, *olah*, *qallel*, *kavod*.
- **Bereshit 8** (Genèse 8:20 — 9:17) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-8.md` — la re-création, l'*olah* de Noach, la *berith* noachide, *adam* intraduisible à partir d'ici, *mabbul*, *olam*.
- **Bereshit 9** (Genèse 9:18-29) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-9.md` — l'incident de la vigne, *ish ha'adamah*, *galah*, *arur* sur Kena'an, dotations de Shem et Yaphet, *shakan* (ambiguïté du sujet maintenue).
- **Bereshit 10** (Genèse 10:1-32) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-10.md` — table des nations, *toledot* des fils de Noach, Nimrod (*gibor*, écho des Nephilim), *mamlakhah*, *lifnei YHWH* (ambiguïté maintenue), Ever / *ivri*, Peleg / *palag*.
- **Bereshit 11** (Genèse 11:1-32) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-11.md` — tour de Bavel, *safah* / *balal* / Bavel (polémique étymologique contre Bab-ilim), *hadal* vs *shavat*, toledot de Shem jusqu'à Terah, *aqarah* (stérilité de Sarai), Haran personne / Haran ville (homonymie délibérée).
- **Bereshit 12** (Genèse 12:1-20) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-12.md` — *lekh-lekha* (ambiguïté maintenue), promesse à Avraham, *vayera* (mode de la révélation aux patriarches), *zera* (premier emploi dans la promesse), *niverekhu* (passif ou réflexif — ambiguïté maintenue), descente en Égypte, *nega'im* (écho de Shemot).
- **Bereshit 13** (Genèse 13:1-18) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-13.md` — retour au Négev et à Bet-El, séparation d'Avram et Lot, *riv* (conflit pastoral), *kikar* (bassin du Yarden), *miqqedem* (mouvement vers l'orient comme éloignement fonctionnel), renouvellement de la promesse aux quatre horizons, *hithalekh ba'arets*, Hevron comme premier ancrage durable.
- **Bereshit 14** (Genèse 14:1-24) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-14.md` — guerre des rois, capture et délivrance de Lot, Malki-tsedeq roi-**kohen** de Shalem, **El Elyon** (premier emploi — intraduisible), **kohen** (intraduisible dès ici), *tsedeq* (l'ordre juste), *qoneh shamayim va'arets*, *ha-ivri* (double étymologie maintenue), *ba'alei berit*, *ma'aser* (ambiguïté du sujet maintenue), identification **YHWH**-**El Elyon** par Avram (v.22).
- **Bereshit 15** (Genèse 15:1-21) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-15.md` — *berith bein habetarim*, **emunah** (intraduisible — verbe *he'emin* rendu "**emuna**"), **tsedaqah** (premier emploi — forme nominale de *tsedeq*), **tsadiq** (déjà posé en Bereshit 6:9), *machazeh* (vision intérieure, distinct de *vayera*), *tardemah* (écho délibéré de Bereshit 2:21), *ger* (premier emploi — étranger résident sans droits), *avon* (premier emploi — torsion structurelle, distinct de *chata* et *ra*), *berith* unilatérale confirmée (seul **YHWH** passe entre les morceaux), prophétie de l'exil et ambiguïté 400 ans / quatrième génération maintenue.
- **Bereshit 16** (Genèse 16:1-16) → `locked/kenesset (le Rassemblement)/torah (la Fondation)/bereshit (Genèse)/bereshit-16.md` — **mal'akh** **YHWH** (premier emploi — intraduisible, ambiguïté délibérée entre le **mal'akh** et **YHWH** maintenue), **El Roï** (premier emploi — unique dans toute la Bible, donné par Hagar), Hagar (*ger* sans droits — première occurrence d'un personnage non-hébreu central), Ishma'el ("El entend"), Beer-lachai-roi, *shiphchah* vs *amah*, ambiguïté de *acharei ro'i* (v.13b — trois lectures maintenues sans résolution).
