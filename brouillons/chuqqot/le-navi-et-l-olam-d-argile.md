...
### Ce que « prophète » nous a fait perdre

Il faut commencer par là, parce que le mot français nous empêche de voir.

*Prophētēs*, en grec, veut dire ==celui qui parle devant, ou à la place de==.
C'est un mot qui décrit ==une fonction== : quelqu'un qui transmet un message. Il
...
Ce qui s'est perdu n'est pas un détail de vocabulaire. C'est ==la différence
entre être et faire==.
...
Et ce n'est ==pas un handicap==. C'est ==l'instrument même==.

Car il faut que le **davar** passe d'un régime à un autre. En haut, il est déjà
entier ; en bas, il doit ==prendre forme== — être dit dans une langue, à une
époque, à des gens qui ont un roi, une famine, une peur précise. ==C'est le
...
Le grec, en fondant les trois en un, a rendu invisible ==la gradation de
profondeur== dans l'accès. On parle de « prophètes » sans plus savoir si l'on
désigne une identité, un mode de vision ordinaire, ou une contemplation de ce
qui est voilé.
...
La raison n'est pas philosophique, elle est ==institutionnelle==, et il vaut
mieux le dire.

Un homme qui est à lui seul envoyé, berger, voyant, annonceur et enseignant
==ne se range pas dans une hiérarchie==. Il concentre trop d'autorité, et il ne
la tient de personne d'ici — il la tient d'avoir été saisi.

Découpe-le en cinq offices, et tu obtiens cinq spécialistes ==dont chacun dépend
de la structure== qui lui reconnaît son titre. Ce qui était une identité devient
==une fonction distribuable==.
...
sévère : ce qui a été dit, on regarde si ça vient.

==L'être est invariant, les actes sont contrôlables.== Confondre les deux mène
...
demander si le compte de cinq n'est pas lui-même un artefact.

La réponse honnête : ==les cinq mots hébreux existent tous, indépendamment de
