...
Pose la question en français, et elle se contredit toute seule : ==comment un
homme sans orgueil peut-il être puissant ?==

L'un des deux mots semble devoir manger l'autre. S'il est puissant, il n'est
pas humble. S'il est humble, il se retient d'être puissant. On en sort par un
compromis — un peu de l'un, un peu de l'autre — et le compromis ne décrit
personne.

La contradiction n'est pas dans la chose. Elle est dans les deux mots français,
et ==tous deux sont faux de la même façon== : ils mesurent une quantité.
L'humilité serait une petite idée de soi ; la puissance, une grande capacité de
contraindre. Deux curseurs sur une même règle — et l'on ne peut pas être en haut
et en bas à la fois.
...
==On tient un outil aussi longtemps qu'on peut le poser. Ce qu'on ne peut plus
poser n'est plus un outil — c'est devenu son **Shem**.==
...
Le document de référence a déjà séparé deux choses que le français confond. Le
**gibbor** est ==celui qui pèse== par sa capacité de contrainte. La **gevurah**
est ==le pouvoir de mener à terme==, et elle ne se mesure pas à ce qu'elle écrase.
Cette chuqqah ne refait pas la distinction : elle s'appuie dessus.

Ce qu'elle ajoute est le statut de la chose. ==Une **gevurah** ne se possède pas
comme une couleur d'yeux. Elle se tient comme un outil.==

Le corpus le dit en propres termes, et il vaut la peine d'entendre la phrase
entière (*Jérémie* 9:22-23) :

*ʾal yithallel chakham bechokhmato* — que le sage ne se glorifie pas de sa
**chokhmah** ; *veʾal yithallel hagibbor bigvurato* (*veʾal yithallel hagibbor
bigvurato* / וְאַל יִתְהַלֵּל הַגִּבּוֹר בִּגְבוּרָתוֹ) — que le **gibbor** ne se
glorifie pas de sa **gevurah** ; que le riche ne se glorifie pas de sa richesse.

Regarde ce qui n'est ==pas== dit. Il n'est pas dit d'être moins sage, moins
puissant, moins riche. ==Les trois choses sont bonnes, et on peut les avoir.== Ce
qui est interdit est ==d'en faire ce dont on se glorifie== — le verbe est *halal*
à la forme réfléchie, *hithallel* : ==se faire briller soi-même par==.

Et l'unique chose dont on puisse se glorifier, le verset suivant la nomme :
*haskel veyadoaʿ ʾoti* (*haskel veyadoaʿ ʾoti* / הַשְׂכֵּל וְיָדֹעַ אוֹתִי) —
==comprendre, et me connaître==. Le second verbe est celui de la **daʿat**, le
connaître par participation, celui où l'on est ==à l'intérieur== de ce que l'on
connaît.

Le corpus a donc mis sur ==un même axe== deux choses que nous rangeons dans deux
rayons différents : ==ce dont un homme se glorifie==, et ==ce qu'il connaît==.

### Et voici où cela touche l'**ʿolam**

La première chuqqah a posé que l'**ʿolam** est ==un rapport de perceptibilité== :
non pas un lieu, mais le fait que quelque chose se dérobe ==à un regard donné==.
D'où sa conséquence la plus dure : deux hommes devant la même scène, et pour l'un
quelque chose se donne, pour l'autre rien — ==sans que la scène ait bougé==. La
différence est dans le **kli**, ==ce qui est apte à recevoir==.

Elle disait que le **kli** décide. Elle ne disait pas ==ce qui décide du **kli**==.

Cette chuqqah en nomme une chose, et une seule : ==vers quoi il est tourné==.

Un **kli** est constitué ==pour== recevoir. Il ne se remplit pas de ce qui existe,
il se remplit de ==ce devant quoi il est placé==. Tourne-le vers le **maqom** — le
lieu où la chose se tient debout — et il reçoit ce que le **maqom** donne.
Tourne-le vers ta propre image, et ==il reçoit encore, mais il ne reçoit plus que
ton image==.

Ce n'est pas une privation de sens : c'est ==le fonctionnement normal d'un
récipient==. Rien n'est en panne. Il est simplement ==orienté ailleurs==, et il
rend fidèlement ce qui lui est présenté.

==Deux propriétés distinctes, et il faut les garder séparées.== La chuqqah du
gradient dit qu'un **kli** ==soutient== plus ou moins de **kavod** — c'est une
question de résistance. Celle-ci dit qu'un **kli** ==est tourné== quelque part —
c'est une question d'orientation. Les deux ne se déduisent pas l'une de l'autre :
==on peut être solide et braqué sur soi==, et alors la solidité ne sert à rien,
parce qu'il n'arrive rien à soutenir.
...
Il faut lire le verset qui en parle le mieux avec attention, parce qu'il ne dit
pas ce qu'on croit (*Ésaïe* 2:11) :
...
Le verset ne supprime pas la hauteur, il dit ==à qui elle revient==. Ce qui est
défait n'est pas un sentiment coupable : c'est ==une place occupée par qui n'y a
pas droit==. C'est très exactement l'opération de la **yirah** — se tenir au rang
qui est le sien — prise par son autre bout.

Le corpus dit d'ailleurs ce que cette position produit : *lifnei shever gaʾon,
...
Celui qui est ==gonflé== tient sa **gevurah** pour ce qu'il est. Il la déploie
pour se voir déployée.

Celui qui ==tond== tient sa **gevurah** pour un droit. Il la déploie pour prendre.
...
### Le critère n'est pas ce qu'on peut faire — c'est ce qu'on peut poser

Comment sait-on si une **gevurah** est encore tenue comme un outil ? On ne le sait
pas en la regardant s'exercer : ==les deux hommes font le même geste==.

On le sait ==au moment où l'outil se retire==.

Le livre des *Shoftim* raconte un **gibbor** dont la force n'a jamais été sienne :
elle venait sur lui, la **Ruach** ==fondait== sur lui, et elle repartait. Un soir
on le réveille en criant que l'ennemi est là. Il se lève et il dit : *je sortirai
comme les autres fois, et je me secouerai*. Puis le texte ajoute cinq mots qui
sont parmi les plus lourds du corpus :

*vehu lo yadaʿ ki YHWH sar meʿalav* (*vehu lo yadaʿ* / וְהוּא לֹא יָדַע) — ==et
lui ne savait pas que **YHWH** s'était retiré de lui== (*Juges* 16:20).

Il ne s'est pas trompé sur ses forces. ==Il ne s'est pas aperçu de la
différence.== Voilà ce que devient un homme dont l'outil est devenu le **Shem** :
non pas quelqu'un qui se croit fort, mais quelqu'un qui ==ne peut plus distinguer==
ce qui lui est prêté de ce qu'il est. Le jour où on le lui reprend, il n'y a
...
==C'est un seul et même mouvement, pris par ses deux bouts.== Le regard qu'on
tourne vers soi pour être vu est exactement celui qu'on retire du champ. ==Se
faire voir coûte de voir.==
...
Il peut ==ne pas le prendre==, parce que rien en lui n'a besoin de paraître fort.

Cette seconde liberté n'a pas de nom en français, et on la confond avec la
faiblesse : ==avoir le moyen d'agir, et ne pas l'employer parce que le **maqom**
ne le demande pas==. Ce n'est pas de la passivité — la passivité n'a pas le choix.
C'est ==un acte, dont on ne voit rien==.

Va voir la scène, elle tient en un seul chapitre, et tout y est dit à cinq versets
d'intervalle.

Un homme est attaqué par son frère et par sa sœur, qui disent de lui, à voix
haute : *haraq ʾakh beMosheh dibber YHWH ? halo gam banu dibber ?* (*haraq ʾakh
beMosheh dibber YHWH* / הֲרַק אַךְ בְּמֹשֶׁה דִּבֶּר יְהוָה) — ==**YHWH**
n'a-t-il parlé qu'à [[Mosheh]] ? N'a-t-il pas parlé par nous aussi ?== (*Nombres*
12:2).

C'est mot pour mot la question du **kli** tourné vers soi : ==qu'est-ce que cela
dit de moi ?==
...
אֲדַבֶּר בּוֹ) — ==bouche à bouche je lui parle, et il contemple la forme de
**YHWH**==.
...
lui dire que d'autres se sont mis à prophétiser dans le camp, et qu'il faudrait
les arrêter. Sa réponse : *umi yiten kol ʿam YHWH neviʾim* (*umi yiten kol ʿam
YHWH neviʾim* / וּמִי יִתֵּן כָּל עַם יְהוָה נְבִיאִים) — ==si seulement tout le
peuple de **YHWH** était **neviʾim** !== (*Nombres* 11:29).

Un homme dont l'accès serait le **Shem** ne dirait jamais cette phrase. ==Il la dit
parce que son accès n'est pas ce qu'il est.==

Et la scène se ferme sur le geste qui prouve tout le reste. Quand le châtiment
tombe sur sa sœur — celle qui l'avait attaqué —, il crie : *ʾEl na refa na lah*
(*ʾEl na refa na lah* / אֵל נָא רְפָא נָא לָהּ) — ==**ʾEl**, je t'en prie,
guéris-la, je t'en prie== (*Nombres* 12:13). ==Il n'avait pas dit un mot pour
lui-même ; il en dit deux pour elle.==
...
Ce qu'il serait tentant d'ajouter, et qu'on n'ajoutera pas : le verbe employé
pour son geste est ==celui de l'élévation==, la racine même de la *rum* que
*Ésaïe* 2 fait ployer. La coïncidence est réelle. Mais c'est aussi le verbe
ordinaire pour lever la main, et ==une racine partagée n'est pas une intention==.
Le §4.9 demande de laisser le texte muet là où il l'est ; il l'est ici.

---

### Notes de la chuqqah

- *==Cette chuqqah est écrite d'après une conversation de l'auteur==, déposée dans *restranscriptions/*. L'énoncé est le sien : *« un **ʿanav** peut utiliser la **gevurah** comme outil sans en être possédé — il prend l'outil quand le champ le demande, il pose l'outil quand le champ ne le demande plus ; l'arrogant ne peut pas poser l'outil parce que l'outil est devenu son identité »*. L'ordre des raisons, le rattachement à l'**ʿolam**, les relevés dans le témoin hébreu et le balisage sont du vault.*
...
- *==Ce que la chuqqah laisse dehors.== La matière porte une application à la constitution propre de l'auteur, qui appartient à son archive personnelle et n'en sort pas. Elle porte aussi le parallèle avec le **naviʾ** comme instrument, qui est l'objet entier de la cinquième chuqqah et n'est repris ici que dans la mesure où il fonde le critère.*
...
- *Juges* 16:20 (à écrire) — *et lui ne savait pas*, le cas où l'outil est devenu le **Shem**.
